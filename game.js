...
var brickWidth = 50;
var brickHeight = 20;
var bricksRows = 5; //numero de linhas
var bricksCols = 20;
var bricksMargin = 15;
var bricksTop = 20;
...
function Brick(x, y) {
    ...
    rect.setAttribute("fill", "#dd" + color + "52");
...
function lost() {
    ...
    message.innerHTML = "Você perdeu! Tente denovo.";
...
function win() {
    ...
    message.innerHTML = "Parabéns! Você venceu!(" + Math.round((end - startDate) / 1000) + "s)";
    message.style.visibility = "visible"; 
}
